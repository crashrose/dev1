...
# def refresh_token
#   token = Rails.application.config.paypal_api_token
# @tokeninfo = token.refresh("jaXPGJ7KIkPkc5Bh9R6kBRFJE6Emmv7M/ukgo46qyTgfIgOt3Yi9Ko/jzj3u09y3nHsld0tyYt03B1rP")
# end

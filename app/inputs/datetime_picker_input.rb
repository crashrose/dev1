class DatetimePickerInput < SimpleForm::Inputs::StringInput
  def input(wrapper_options)
    ...
    picker_pettern = input_html_options[:data].include?(:date_format) ? input_html_options[:data][:date_format] : 
...
### No longer needed, just added the 'form-control' class via a push to input_html_classes in the input method above
